...
<body>
    ...
    <script>
        ...
        const INITIAL_ZOOM = 1;
        mapboxgl.accessToken = 'pk.eyJ1IjoibmFuYWpvbjY2IiwiYSI6ImNtMnJxMmZtNTAwYWcyc3B1bGtzdjR5NTkifQ.5aPfUP-w8DUsBpaqVgjG9A';
        // let openPopup = null; // Initialize this globally, outside the loop
    ...
    stateHospitals.forEach(hospital => {
        ...
        // Make the hospital name clickable by adding a fly-to event
        listItem.innerHTML = `
            ...
            EHR System: ${hospital.ehr_system}
        `;
        ...
        // Optional: Set background color based on the EHR system
        listItem.style.backgroundColor = hospital.ehr_system === 'SystemA' ? '#ff8502' : '#0f2844';
...
<body>
    ...
    <div class="mapbox-button-group">
        ...
        <!-- Reposition the geocoder toggle and container here -->
        <div id="geocoder-toggle-container">
    ...
    geocoderToggle.addEventListener("click", () => {
