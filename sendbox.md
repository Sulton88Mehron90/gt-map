...
<style>
    ...
    .mapbox-button-group button:hover {
        ...
        /* background: linear-gradient(145deg, #ffa849, #ff8502); */
    ...
    /* Hide content in the collapsed state */
    ...
    #hospital-list-sidebar.collapsed .sidebar-header {
        justify-content: flex-start;
    }

    /* Highlight the sidebar while dragging */
...
#toggle-geocoder {
    ...
    @media (max-width: 480px) {
        ...
        #hospital-list-sidebar.minimized {
            width: 30px;
        }
...
<body>
    ...
    <div id="hospital-list-sidebar" style="display: none;">
        <div class="sidebar-header">
            <a href="https://goliathtechnologies.com/" target="_blank">
                <img src="./img/gtLogo.png" alt="Goliath Technologies Logo" class="sidebar-logo">
            </a>
            <div class="button-group">
                ...
                <!-- <button id="toggle-theme" aria-label="Toggle Theme" class="round-button">
    ...
    <div class="mapbox-button-group">
        ...
        <!-- Geocoder field and toggle button -->
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // search. geocoder instance and add it to the map
    ...
    geocoderToggle.addEventListener("click", (e) => {
        ...
        if (geocoderContainer.style.display === "none") {
            ...
            geocoderToggle.style.display = "none"; // Hide the toggle icon
            ...
            geocoderToggle.style.display = "flex"; // Show the toggle icon again
        }
    });
    ...
    let popupContent = `
        ...
        EHR System: ${ehr_system}<br>
        Address: ${hospital_address}
    `;

   // Add a special note if this is the CommonSpirit Health Headquarters
// if (hospital_name === "CommonSpirit Health Headquarters") {
//     popupContent += `<br><strong style="color: red;">Note:</strong> CommonSpirit Health operates over 140 hospitals across 21 states. 
//     <a href="https://www.commonspirit.org/" target="_blank" style="color: red;">Visit Website</a>`;
// }
                        ...
                        map.on('click', 'us-states-fill', (e) => {
                            ...
                            if (stateHospitals.length > 0) {
                                stateHospitals.forEach(hospital => {
                                    ...
                                    // Display hospital name, EHR system with logo, and location details
//                                     listItem.innerHTML = `
...
//     EHR System: ${ehrLogo}${hospital.ehr_system}
// `;
...
listItem.innerHTML = `
    ...
    ${hospital.parent_company ? `Parent Company: ${hospital.parent_company}<br>` : ""}
    ${hospital.location}<br>
    EHR System: ${ehrLogo}${hospital.ehr_system}
`;
...
if (hospital.hospital_name === "CommonSpirit Health Headquarters") {
    ...
    <a href="https://www.commonspirit.org/" target="_blank" style="color: #06b4fd;">Visit Website</a>`;
                                    ...
                                    // // Set background color based on the EHR system
                                    // listItem.style.backgroundColor = hospital.ehr_system === 'SystemA' ? '#ff8502' : '#0f2844';

                                    list.appendChild(listItem);
                                });

                                sidebar.style.display = 'block'; // Show sidebar only if there is data
                            } else {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Function to handle the start of dragging (touch or mouse)
            ...
            // Function to handle dragging (touchmove or mousemove)
            ...
            // Function to end dragging (touchend or mouseup)
            function endDrag() {
                isDragging = false;
                sidebar.classList.remove("dragging");
                constrainToViewport(sidebar);
            ...
            // So the sidebar stays within viewport
            function constrainToViewport(element) {
                const rect = element.getBoundingClientRect();
                const windowWidth = window.innerWidth;
                const windowHeight = window.innerHeight;
            ...
            // Touch and mouse events to the sidebar header for dragging
            const header = sidebar.querySelector(".sidebar-header");
            header.addEventListener("mousedown", startDrag);
            document.addEventListener("mousemove", handleDrag);
            document.addEventListener("mouseup", endDrag);

            // Touch event listeners for mobile screens
